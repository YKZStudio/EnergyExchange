...
- Target Minecraft 26.1.2, 26.2 and 26.3 Fabric with separate JARs. Minimum Loader: 0.18.4 for 26.1.2, 0.19.3 for 26.2, 0.19.5 for 26.3; optional mods may require newer Loader. Verify each target before widening compatibility.
