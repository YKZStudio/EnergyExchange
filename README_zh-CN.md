...
[English](README.md) · [更新日志](docs/releases/0.2.0-pre2.md) · [数据包](docs/DATAPACKS_zh-CN.md) · [开发与验收](docs/DEVELOPMENT_zh-CN.md)

面向 **Minecraft Java 26.2 + Fabric** 的独立能量交换模组。受等价交换玩法启发，未使用 ProjectE 代码或素材，也不是官方移植。

**0.2.0-pre2：物品 → 个人 能量 与知识 → 转化桌购买物品或经验。**
...
拼音搜索**默认关闭**。开启后，`moyingzhenzhu`、`myzz`、`moyzz` 都可找到「末影珍珠」，支持大小写、空格和音节前缀混拼，无需安装 REI。搜索针对当前语言下的物品名称；暂不提供错字纠正，部分多音字采用默认读音。
